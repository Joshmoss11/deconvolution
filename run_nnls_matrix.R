...
write.csv(nnls.betas,file.path(nnls.dir,'nnls_betas.csv'),row.names=T,quote=F)
...
write.csv(nnls.betas.norm,file.path(nnls.dir,'nnls_betas_norm.csv'),row.names=T,quote=F)
